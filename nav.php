    ...
    <div class="topbar container-fluid">
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
                    aria-haspopup="false" aria-expanded="false">
                    <img src="<?=asset('theme/assets/images/flags/us.jpg')?>" alt="user-image" class="me-0 me-sm-1" height="12">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?=asset('theme/assets/images/flags/us.jpg')?>" alt="user-image" class="me-1" height="12"> <span
                            class="align-middle">English</span>
                    </a>
                    
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?=asset('theme/assets/images/flags/indonesia.jpg')?>" alt="user-image" class="me-1" height="12"> <span
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button"
                    ...
                    <span class="account-user-avatar">
                        <img src="<?=asset('theme/assets/images/users/avatar-1.jpg')?>" alt="user-image" width="32" class="rounded-circle">
                    </span>
                    <span class="d-lg-block d-none">
                        <h5 class="my-0 fw-normal"><?=auth()->name?> <i
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                    ...
                    <!-- item-->
                    <a href="<?=routeTo('default/profile')?>" class="dropdown-item">
                        <i class="ri-account-circle-line fs-18 align-middle me-1"></i>
                        <span>My Account</span>
                    </a>

                    <!-- item-->
                    <a href="<?=routeTo('auth/logout')?>" class="dropdown-item">
